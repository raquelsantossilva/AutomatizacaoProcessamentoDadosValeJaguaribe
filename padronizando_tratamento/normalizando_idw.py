...
df = pd.read_csv(r"C:\Users\12bea\OneDrive\Documentos\SBBD_algoritms\arquivo_interpolado_idw.csv")
...
df_normalizado.to_csv("arquivo_normalizado_idw.csv",index=False)
