...
def main() -> None:
    ...
    # ------------------------------------------------------------------ #
    processed_dir = Path(r"C:\Users\12bea\OneDrive\Documentos\SBBD_algoritms\algoritmos_sem_interpo")
    processed_dir.mkdir(parents=True, exist_ok=True)
    # ------------------------------------------------------------------ #
    # 2. Carregamento dos dados
    # ------------------------------------------------------------------ #
   
    df = pd.read_csv(r"C:\Users\12bea\OneDrive\Documentos\SBBD_algoritms\arquivo_normalizado_sem_inter.csv")
    ...
    result_file = processed_dir / f"isolation_forest_sem_inter.csv"
    ...
    metrics_file = processed_dir / f"isolation_forest_metrics_sem_inter.json"
