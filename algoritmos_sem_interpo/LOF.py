...
def main() -> None:
    ...
    # ------------------------------------------------------------------ #
    data_dir       = Path(r"C:\Users\12bea\OneDrive\Documentos\SBBD_algoritms\arquivo_normalizado_sem_inter.csv")
    ...
    result_file = processed_dir / f"lof_sem_inter.csv"
    ...
    metrics_file = processed_dir / f"lof_metrics_sem_inter.json"
