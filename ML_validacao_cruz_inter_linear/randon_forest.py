...
pasta_saida = Path(r"C:\Users\12bea\OneDrive\Documentos\SBBD_algoritms\ML_validacao_cruz_inter_linear")
pasta_saida.mkdir(parents=True, exist_ok=True)

arquivos = {
    "isolation_forest": Path(r"C:\Users\12bea\OneDrive\Documentos\SBBD_algoritms\algoritmos_inter_linear\isolation_forest.csv"),
    "knn":              Path(r"C:\Users\12bea\OneDrive\Documentos\SBBD_algoritms\algoritmos_inter_linear\knn.csv"),
    "lof":              Path(r"C:\Users\12bea\OneDrive\Documentos\SBBD_algoritms\algoritmos_inter_linear\lof.csv"),
    "svm":              Path(r"C:\Users\12bea\OneDrive\Documentos\SBBD_algoritms\algoritmos_inter_linear\svm.csv"),
}
...
for tecnica, metrics in resultados.items():
    metrics_file = pasta_saida / f"{tecnica}3_metrics.json"
