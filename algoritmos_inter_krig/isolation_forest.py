...
def main() -> None:
    ...
    # ------------------------------------------------------------------ #
    processed_dir = Path(r"C:\Users\12bea\OneDrive\Documentos\SBBD_algoritms\algoritmos_inter_krig")
    processed_dir.mkdir(parents=True, exist_ok=True)
    # ------------------------------------------------------------------ #
    # 2. Carregamento dos dados
    # ------------------------------------------------------------------ #
   
    df = pd.read_csv(r"C:\Users\12bea\OneDrive\Documentos\SBBD_algoritms\arquivo_normalizado_krig.csv")
